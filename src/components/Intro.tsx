  ...
  return (
    ...
    >
      ...
      <ui.VStack textAlign={'center'} gap={10} lineHeight={3} mt='80px'>
        ...
        <ui.Text fontSize={'18px'}>늘 저희보다 앞서 걸으며 따뜻하게 품어주셨던<br />어머니의 크고 깊은 사랑에 이제는 저희가 보답하고자 합니다.</ui.Text>
        <ui.Text fontSize={'18px'}>어머니께서 걸어오신<br />아름다운 인생길에 감사와 존경을 표하며, <br />가족과 함께 기쁨을 나누는 소중한 시간을 보내고자 합니다.</ui.Text>
